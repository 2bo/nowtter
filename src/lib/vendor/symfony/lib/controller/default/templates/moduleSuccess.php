...
<dl class="sfTMessageInfo">
    ...
    <dd>This page is part of the symfony <code>default</code> module. It will disappear as soon as you override the
        <code>index</code> action in the new module.
    </dd>
    ...
    <dd>
        <ul class="sfTIconList">
            ...
            <li class="sfTEditMessage">In <code>actions/actions.class.php</code>, edit the <code>executeIndex()</code>
                method and remove the final <code>forward</code></li>
