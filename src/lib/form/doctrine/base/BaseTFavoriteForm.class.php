...
/**
 * TFavorite form base class.
 *
 * @method TFavorite getObject() Returns the current form's model object
 *
 * @package    nowtter
 * @subpackage form
 ...
 */
abstract class BaseTFavoriteForm extends BaseFormDoctrine
{
    public function setup()
    {
        ...
        $this->widgetSchema->setNameFormat('t_favorite[%s]');
