...
/**
 * TRetweet form base class.
 *
 * @method TRetweet getObject() Returns the current form's model object
 *
 * @package    nowtter
 * @subpackage form
 ...
 */
abstract class BaseTRetweetForm extends BaseFormDoctrine
{
    public function setup()
    {
        ...
        $this->widgetSchema->setNameFormat('t_retweet[%s]');
