 ...
 * @property TUserProfile $TUserProfile
 ...
 * @method TUserProfile          getTUserProfile()          Returns the current record's "TUserProfile" value
 ...
 * @method sfGuardUser           setTUserProfile()          Sets the current record's "TUserProfile" value
 * @method sfGuardUser           setTweets()                Sets the current record's "Tweets" collection
 * @method sfGuardUser           setFollows()               Sets the current record's "Follows" collection
 * @method sfGuardUser           setFavorites()             Sets the current record's "Favorites" collection
 * @method sfGuardUser           setRetweets()              Sets the current record's "Retweets" collection
 * 
 * @package    nowtter
 * @subpackage model
...
abstract class BasesfGuardUser extends sfDoctrineRecord
{
    ...
    public function setUp()
    {
        ...
        $this->hasOne('TUserProfile', array(
            'local' => 'id',
            'foreign' => 'user_id'));
